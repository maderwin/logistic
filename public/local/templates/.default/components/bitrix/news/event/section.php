        ...
        <div class="row">
            <div class="col-md-8">
                <div class="row hidden">
                    <div class="col-md-12">
                        <div class="full_banner" style="background-image: url(<?=P_ASSETS?>img/full_banner.jpg);">
                            <div class="title">Транспортные проекты</div>
                        </div>
                    </div>
                </div>
                <?$APPLICATION->IncludeComponent(
