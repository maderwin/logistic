...
$APPLICATION->SetTitle("Пресс-релизы компаний");
?><?$APPLICATION->IncludeComponent("bitrix:news", "press", Array(
    ...
    "SEF_FOLDER" => "/analytics/press/",	// Каталог ЧПУ (относительно корня сайта)
