...
?><?$APPLICATION->IncludeComponent("bitrix:news", "interview", Array(
    ...
    "IBLOCK_ID" => constant("IB_CONTENT_INTERVIEW"),	// Инфоблок
    ...
    "SEF_FOLDER" => "/analytics/interview/",	// Каталог ЧПУ (относительно корня сайта)
