...
?><?$APPLICATION->IncludeComponent("bitrix:news", "docs", Array(
    ...
    "IBLOCK_ID" => constant("IB_CONTENT_DOCS"),	// Инфоблок
    ...
    "SEF_FOLDER" => "/analytics/docs/",	// Каталог ЧПУ (относительно корня сайта)
