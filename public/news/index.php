...
?><?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"DETAIL_PROPERTY_CODE" => array("CITY","SOURCE","THEME",""),
		...
		"SEF_FOLDER" => "/news/",
		"SEF_MODE" => "Y",
		"SEF_URL_TEMPLATES" => Array("detail"=>"#ELEMENT_ID#-#ELEMENT_CODE/","news"=>"","rss"=>"rss/","rss_section"=>"#SECTION_CODE#/rss/","search"=>"search/","section"=>"#SECTION_CODE#/"),
		"SET_LAST_MODIFIED" => "Y",
		"SET_STATUS_404" => "Y",
		"SET_TITLE" => "Y",
		"SHOW_404" => "Y",
